"""2 days, 6 configs. Write results to data/compare_2day.txt."""
import json, sys
...
files = sorted(DATA_DIR.glob("mnq_*_RTH_*.dbn"))[:2]
...
lines = ["=== 2-day (02-04, 02-05) comparison ==="]
for name, _ in configs:
    ...
    lines.append(f"{name:25} trades={t:2}  pnl_pts={pnl_pts:7.1f}  wr={wr:5.1f}%  avg_pts/trade={avg:5.2f}")
out = DATA_DIR / "compare_2day.txt"
out.write_text("\n".join(lines))
